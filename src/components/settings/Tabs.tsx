...
const Tabs = ({ activeTab, setActiveTab }: TProps) => {
  return (
    <div className="border-b border-[#F4F5F7] pt-2 flex justify-center md:block">
      <nav className="flex">
        <button
          className={`px-4 !bg-none py-4 text-sm font-medium transition-all duration-300 ease-linear ${
        ...
        <button
          className={`px-4 py-4 !bg-none text-sm font-medium transition-all duration-300 ease-linear ${
